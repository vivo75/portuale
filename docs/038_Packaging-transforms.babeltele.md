...
STATUS: IN-PROGRESS S0-S4 done 2026-09-13(§11; TEST/findings/l2.md `#38 S1/S2/S3/S4`+`#38 recon`); S0 PORTAGE_TMPDIR finding⇒#37 follow-up LANDED; S4 user⇒IMPLEMENT instprep(¬#38b); remaining S5(closeout); #37 LANDED (resolved FEATURES+PORTAGE_COMPRESS*+USE+SLOT in phase env)
...
§9 DOD: [x]S0 table+tool table+instprep call-order cited; expected trees frozen from O | [x]l2-gpkg-docompress closed(S1); l2-gpkg-dostrip-splitdebug* closed(S2)—each w/ before/after evidence | [x]RESTRICT=strip cell pinned by both-PM fixture(S3) | [x]instprep: implemented+fixtured(S4 run_instprep; repro l2-instprep-20260913T201638Z green) | [ ]no transform reimplemented∈Rust; no vendored bin/* edited | [x]L2 porttest 0-unexplained(l2-20260913T191450Z); [~]L1 unchanged(post-S4 l1-20260913T202308Z 0 hard; S5 reruns); [~]full verification green(post-S4 green; S5 reruns) | [ ]docs updated(S5); no dead allowlist entries
