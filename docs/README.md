...
| `<tier>.<item>-<slug>.opus.md` / `.md` | **Per-item implementation plans**, one per backlog item, named for the tier and item number they implement (e.g. [`06.057-directly_requested_hard_atom_conflict.opus.md`](06.057-directly_requested_hard_atom_conflict.opus.md) is Tier 6 #57). Each carries its own §0 slice rules, owner decisions, slice table and file-conflict map. Their `Status:` header says `proposed` or `done <date>` — a `done` plan is kept for the derivation trail; `backlog-tasks.md` is what actually landed. Legacy plans use the `.opus.md` suffix, current ones plain `.md` (`ls docs/0[0-9].*` lists the set). The six reviewed in [`review-46-53-54-57-55-56.md`](review-46-53-54-57-55-56.md) plus `07.058`/`07.60`/`07.61` are done; the 2026-09-16 batch (notably `01.063`/`01.064` done, `01.014`/`01.067`/`01.068`/`02.059`/`02.065`/`02.066` proposed) is current. |
