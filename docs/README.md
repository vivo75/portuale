...
| `<tier>.<item>-<slug>.opus.md` | **Per-item implementation plans**, one per backlog item, named for the tier and item number they implement (e.g. [`06.057-directly_requested_hard_atom_conflict.opus.md`](06.057-directly_requested_hard_atom_conflict.opus.md) is Tier 6 #57). Each carries its own §0 slice rules, owner decisions, slice table and file-conflict map. Their `Status:` header says `proposed` or `done <date>` — a `done` plan is kept for the derivation trail; `backlog-tasks.md` is what actually landed. Current set: [`05.046`](05.046-metadata_md5-cache.opus.md) (md5-cache validation), [`06.053`](06.053-merge_order.opus.md) (merge order), [`06.054`](06.054-residual_conflict.opus.md) (residual conflict), [`06.057`](06.057-directly_requested_hard_atom_conflict.opus.md) (installed-instance slot collision), [`07.55`](07.55-layout_conf_cache_formats.opus.md) (`cache-formats`), [`07.56`](07.56-gpkg_outer_container.opus.md) (gpkg outer container) — all six done, reviewed in [`review-46-53-54-57-55-56.md`](review-46-53-54-57-55-56.md). |
